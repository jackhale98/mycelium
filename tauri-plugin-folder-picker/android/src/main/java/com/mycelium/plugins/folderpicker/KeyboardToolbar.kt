...
/**
 * The accessory bar that sits above the software keyboard while editing.
 *
 * Split out of the plugin so the plugin stays a command surface: this owns a
 * view and its lifecycle, which has nothing to do with reaching the vault.
 */
class KeyboardToolbar(private val activity: Activity) {
